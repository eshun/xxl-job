...
public class JobTriggerPoolHelper {
    ...
    private ThreadPoolExecutor fastTriggerPool = new ThreadPoolExecutor(
            ...
            new ThreadFactory() {
                ...
                public Thread newThread(Runnable r) {
                    return new Thread(r, "xxl-job, console JobTriggerPoolHelper-fastTriggerPool-" + r.hashCode());
                }
            });
    ...
    private ThreadPoolExecutor slowTriggerPool = new ThreadPoolExecutor(
            ...
            new ThreadFactory() {
                @Override
                public Thread newThread(Runnable r) {
                    return new Thread(r, "xxl-job, console JobTriggerPoolHelper-slowTriggerPool-" + r.hashCode());
                }
            });
